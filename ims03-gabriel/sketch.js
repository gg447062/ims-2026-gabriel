// https://editor.p5js.org/gg447062/sketches/UHoRrsNbQ
...
function modulateFreq() {
  let wibble = sin(tOsc * 4) * 2;
  let wobble = sin(tOsc * 6) * 2;
  let wabble = wibble + wobble;

  let comparator = wabble > 0 ? 10 : -10;
  let mainFreq = sin(tOsc) * 0 + 150;
  // let wobble = sin(t) * 60;
  // wobble += bigWobble
  // let pct = (tOsc * 10) % 60;
  // wobble = easeOutBounce(pct);

  osc.freq(mainFreq + comparator);
}

// easing adapted from here https://easings.net/#easeOutBounce
